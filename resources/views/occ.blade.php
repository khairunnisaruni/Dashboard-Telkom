...
<div class="flex min-h-screen">
    ...
    {{-- Sidebar --}}
    @include('partials.sidebar') {{-- Pastikan sidebar di sini --}}
 ...
 <div x-data="{ showUploadModal: false }" class="flex-1 flex flex-col pt-24 md:ml-64 md:pt-16">
    ...
    {{-- Main content --}}
    <main class="flex-1 flex flex-col pt-20 md:ml-64 md:pt-16 p-4 md:p-6" x-data="{ showUploadModal: false }">

        {{-- Navbar/Header --}}
        @include('partials.header')

        {{-- Judul halaman --}}
        <h1 class="text-xl md:text-2xl font-bold mb-4" style="margin-top: 60px;">OCC and Idle Port</h1>
    ...
    <div x-show="showUploadModal" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div class="bg-white w-full max-w-xl rounded-lg p-6 shadow-lg relative">
            <button @click="showUploadModal = false" class="absolute top-2 right-2 text-gray-500 hover:text-gray-700 text-xl">&times;</button>
