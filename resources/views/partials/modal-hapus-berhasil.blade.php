<div 
    x-show="showHapusBerhasilModal" 
    x-cloak
    @keydown.escape.window="showHapusBerhasilModal = false"
    @click.away="showHapusBerhasilModal = false"
...
>
    <div @click.stop 
        ...
        {{-- Subtitle --}}
        <p class="text-gray-700 mb-6">Data telah berhasil di hapus</p>

        {{-- Button OK --}}
        <button 
            @click="showHapusBerhasilModal = false"
